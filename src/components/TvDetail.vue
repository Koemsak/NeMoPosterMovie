<template>
  <v-container>
        ...
        <v-col cols="12" xl="10" lg="9" md="9" sm="12">
          ...
          >
            ...
            <div class="d-flex align-center">
              <small class="text-small text-sm-body-2 mb-0 warning--text"
                >Release Date:</small
              >
            ...
            <div class="d-flex">
              <small
                class="text-small text-sm-body-2 warning--text text-capitalize"
                >Overview:
                <span class="darkColor--text font-weight-normal mb-0">{{
    ...
    <!-- Tv Episodes -->
    <p class="mt-4">
      {{ detail.seasons && detail.seasons.length > 0 ? "All Episodes:" : "" }}
    </p>
    <tv-episode-card :posters="detail.seasons" />
...
import TvEpisodeCard from "./TvEpisodeCard.vue";
export default {
  name: "TvDetail",
  props: ["detail", "credit"],
  components: {
